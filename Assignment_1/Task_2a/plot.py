...
def gen_plots(model,epoch):
    ...
    ax.set_title(f"HL 1, Node 1 (epoch: {epoch} )")
    ax.set_xlabel("x1")
    ax.set_ylabel("x2")
    ax.set_zlabel("Value")
    ...
    ax.set_title(f"HL 1, Node 2 (epoch: {epoch} )")
    ax.set_xlabel("x1")
    ax.set_ylabel("x2")
    ax.set_zlabel("Value")
    ...
    ax.set_title(f"HL 1, Node 3 (epoch: {epoch} )")
    ax.set_xlabel("x1")
    ax.set_ylabel("x2")
    ax.set_zlabel("Value")
    ...
    ax.set_title(f"HL 1, Node 4 (epoch: {epoch} )")
    ax.set_xlabel("x1")
    ax.set_ylabel("x2")
    ax.set_zlabel("Value")
    ...
    ax.set_title(f"HL 2, Node 1 (epoch: {epoch} )")
    ax.set_xlabel("x1")
    ax.set_ylabel("x2")
    ax.set_zlabel("Value")
    ...
    ax.set_title(f"HL 2, Node 2 (epoch: {epoch} )")
    ax.set_xlabel("x1")
    ax.set_ylabel("x2")
    ax.set_zlabel("Value")
    ...
    ax.set_title(f"Output (epoch: {epoch} )")
    ax.set_xlabel("x1")
    ax.set_ylabel("x2")
    ax.set_zlabel("Value")
